...
const FilterItem = (props) => {
	...
	const { handleCollapse, handleGetType, handleGetSaleId, handleGetSort, isClear } = props;
	...
	return (
		<div className="__filter">
			<div className="wrap-sort">
				<Input className="filter-sort-id" placeholder="Item ID" onChange={handleChangeSaleId} />
			</div>
			<div className="wrap-sort">
				<Select value={paramFilter.itemType ? paramFilter.itemType : 'All'} className="filter-sort-slt" onChange={handleChangeType}>
