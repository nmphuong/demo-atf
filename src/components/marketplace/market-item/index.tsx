...
import { useGamePlayContract } from '../../../hooks/useContract';
...
const MarketItem = () => {
    ...
    const getDataAsset = async () => {
        ...
        try {
            let res = await MarketApi.getListAsset(param, 'ITEM');
                            ...
                            <div className="_item-list-item" key={index}>
                                <div className="asset-item">
                                    ...
                                    <div className="asset-image-item">
                                        <img src={item.nftImage == null || item.assetImage == '' ? NoneImg : item.assetImage} />
                                        <div className="mk-box-name">{item.name}</div>
                                    </div>
                                        ...
                                        <div className="btn-action">
                                            ...
                                            <div className="gr-action">
                                                <Button className="btn-gold-claim font-normal"
                                                    onClick={(event) => (window.location.href = `/marketplace/item/${item.id}`)}
                                                >
                                                    Detail
                                                </Button>
                                            </div>
                                ...
                                <div className="_item-list-item">
                                    <div className="asset-item">
                                        ...
                                        <div className="asset-image-item">
                                            ...
                                            <div className="mk-box-name">UPGRADE</div>
                                        </div>
                                        <div className="asset-name">
                                            <div className="btn-action">
                                                {/* <div className="mk-box-price">
                                                ...
                                                <div className="gr-action">
                                                    <button className="btn-gold-claim font-normal" onClick={() => { }}>
                                                        <span>BUY</span>
                                                    </button>
                                                </div>
                                            </div>
